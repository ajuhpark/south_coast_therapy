    ...
    Example.timescale = function() {
        ...
        var explosion = function(engine) {
            ...
            for (var i = 0; i < bodies.length; i++) {
                ...
                // Only affect non-static bodies that are near the bottom (y >= 500)
        ...
        // Create a grid of small bouncy circles (15 wide, 3 tall)
        // Reference to "Swordfish" - a movie with bullet-time effects
        // 15 wide circles, 3 tall circles. = 45 circles total. 
        World.add(world, Composites.stack(20, 100, 15, 3, 20, 40, function(x, y) {
        // World.add(world, Composites.stack(20, 100, 2, 1, 20, 40, function(x, y) {
            // Each circle has random radius between 10-20 pixels
            return Bodies.circle(x, y, Common.random(10, 20), bodyOptions);
        }));

        // Create larger random objects (8 wide, 3 tall)
        // 8, 3 = 8 wide × 3 tall = 24 shapes total
        World.add(world, Composites.stack(50, 50, 8, 3, 0, 0, function(x, y) {
        // World.add(world, Composites.stack(50, 50, 2, 1, 0, 0, function(x, y) {
            ...
            case 1:
                // Create random polygon with 4-8 sides
        ...
        var bottomWall = Bodies.rectangle(matter_container_2.clientWidth / 2, matter_container_2.clientHeight, matter_container_2.clientWidth, 50, { isStatic: true });
        var rightWall = Bodies.rectangle(matter_container_2.clientWidth, matter_container_2.clientHeight / 2, 50, matter_container_2.clientHeight, { isStatic: true });
        var leftWall = Bodies.rectangle(0, matter_container_2.clientHeight / 2, 50, matter_container_2.clientHeight, { isStatic: true });
        ...
        World.add(world, [topWall, bottomWall, rightWall, leftWall]);
        ...
        function handleResize2(matter_container_2) {
            ...
            Matter.Body.setPosition(
                ...
                Matter.Vector.create(
                    matter_container_2.clientWidth / 2,
                    matter_container_2.clientHeight
                )
            );
