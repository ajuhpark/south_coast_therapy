...
function sct_home() {
  ...
  function init() {
    ...
    let nav_menu_link_elements = Array.from(document.querySelectorAll(".sj_banner_1_header_link, .sct_rounded_dropdown_arrow_2, .sct_btn-parent"))
    ...
    sct_banner_tl
      ...
      // "<",
      // )
      .slideUp(nav_menu_link_elements, {}, "sct_bannerl_tl_start")
      .slideUp(split_sct_banner_name_word_text.words, {}, "sct_bannerl_tl_start+=0.4")
