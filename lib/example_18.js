...
if (typeof gsap === 'undefined') {
  console.error('GSAP failed to load properly');
}
  ...
  function init() {
    ...
    function slideIn() {
      ...
      if (current !== undefined) {
        ...
        //     yPercent: -15,
        //     // ...tlDefaults
        //     // trying out this from claude instead
        //     ease: tlDefaults.ease,        // Explicit property
        //     duration: tlDefaults.duration // Explicit property
        //   }),
      ...
      //     gsap.to(pg_images[current], {
      //       yPercent: -15,
      //       ease: "slow.inOut",      // Direct value instead of spread
      //       duration: 1.25           // Direct value instead of spread
      //     }),
      //     0  // Start at the same time as slide-in
      //   ).add(
      //     // After animation, reset the previous section's positions
    ...
    function slideOut() {
      ...
      //   // the below is the new one claude offered
      //   .add(() => revealSectionHeading(), ">-1")
    ...
    //   // Add the heading animation separately to ensure it's valid
    //   const headingAnimation = revealSectionHeading();
    //   if (headingAnimation) {
    //     tl.add(headingAnimation, ">-1");
    //   }
    // }
