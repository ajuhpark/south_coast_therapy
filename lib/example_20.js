...
function example_20() {
  ...
  for (let i = 0; i < 20; i++) {
    ...
    function matter_container_2(){
      ...
      Example.timescale = function() {
          ...
          World.add(world, Composites.stack(
            ...
            3,                                          // rows (number of shapes vertically)
    ...
    function matter_container_3(){
      // new matter js container 
      const matter_container_3 = document.querySelector("#matter_container_3")
      ...
      Example.timescale = function() {
          ...
          var bodyOptions = {
              ...
              restitution: 1.1     // Higher bounciness to maintain energy (0 = no bounce, 1 = perfect bounce)
          };
          ...
          World.add(world, Composites.stack(
            ...
            function(x, y) {
              // Circle radius relative to container size (2-8% of container width)
              var minRadius = matter_container_3.clientWidth * 0.13;
              var maxRadius = matter_container_3.clientWidth * 0.28;
              var circleOptions = Object.assign({}, bodyOptions, {
                  render: { fillStyle: Common.choose(colors) }
              });
              return Bodies.circle(x, y, Common.random(minRadius, maxRadius), circleOptions);
          ...
          World.add(world, Composites.stack(
              ...
              case 0:
                  ...
                  if (Common.random() < 0.8) {
                      // Square rectangles: 3-12% of container width/height
                      var minSize = matter_container_3.clientWidth * 0.1;
                      var maxSize = matter_container_3.clientWidth * 0.3;
                      return Bodies.rectangle(x, y, Common.random(minSize, maxSize), Common.random(minSize, maxSize), shapeOptions);
                  } else {
                      // Long thin rectangles: width 5-15%, height 2-6% of container
                      var minWidth = matter_container_3.clientWidth * 0.1;
                      var maxWidth = matter_container_3.clientWidth * 0.2;
                      var minHeight = matter_container_3.clientHeight * 0.1;
                      var maxHeight = matter_container_3.clientHeight * 0.15;
                      return Bodies.rectangle(x, y, Common.random(minWidth, maxWidth), Common.random(minHeight, maxHeight), shapeOptions);
                  }
              case 1:
                  // Create random polygon with 4-8 sides, radius 2-8% of container width
                  var minRadius = matter_container_3.clientWidth * 0.05;
                  var maxRadius = matter_container_3.clientWidth * 0.18;
                  return Bodies.polygon(x, y, Math.round(Common.random(4, 8)), Common.random(minRadius, maxRadius), shapeOptions);
              }
          }));
              ...
              for (var i = 0; i < allBodies.length; i++) {
                  ...
                  if (!body.isStatic) {
                      ...
                      Matter.Body.setVelocity(body, {
                          x: Common.random(-160, 160),  // Random horizontal velocity (-3 to 3)
                          y: Common.random(-160, 160)   // Random vertical velocity (-2 to 1, mostly upward)
                      });
                  }
              }
