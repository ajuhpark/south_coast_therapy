...
function init(){
    ...
    const heroTitles = document.querySelectorAll('.bm_new-banner-title')
    const heroImageStart = document.querySelector('.bm_hero-image-start')
    const heroCaption = document.querySelector('.bm_new-banner-caption')
    const heroButton = document.querySelector('.bm_new-banner-button')
