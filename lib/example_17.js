...
function example_17() {
  ...
  function init() {
    ...
    rejoice_tl
      .to(".ep_menu_menu-overlay_2", {
        duration: 1,
        clipPath: "polygon(0 0, 100% 0, 100% 100%, 0 100%)",
        ease: "power2.out",
      })
      .from(
        ".ep_menu_menu-link_2, .ep_menu_btn_2",
        {
          opacity: 0,
          y: 60,
          stagger: 0.05,
    ...
    function openMenu() {
      document.querySelector(".ep_menu_menu-overlay_2").style.pointerEvents = "all";
      rejoice_tl.play();
    }
  
    function closeMenu() {
      document.querySelector(".ep_menu_menu-overlay_2").style.pointerEvents = "none";
      rejoice_tl.reverse();
    }
  
    document.querySelector(".ep_menu_menu-open-btn_2").addEventListener("click", openMenu);
    document
      .querySelector(".ep_menu_menu-close-btn_2")
