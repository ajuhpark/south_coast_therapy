...
function example_14() {
  ...
  function init() {
    console.log("example_14 init function is working apapapa");
    gsap.from("html", { duration: 0, autoAlpha: 0 });

    // nav timeline - banner 1
    let banner_1 = document.querySelector(".ap_grid_container.banner_1");

    let sjs_logo_image_banner_1 = banner_1.querySelector("#sjs_logo_image_banner_1");
    let sjs_logo_text_banner_1 = banner_1.querySelector("#sjs_logo_text_banner_1");
    ...
    let sjs_nav_content_right = banner_1.querySelector(".sjs_nav_content_right")
    ...
    let tl_banner_1 = gsap.timeline({id: "tl_banner_1"})
