...
function example_14() {
  ...
  function init() {
    ...
    let sjs_banner_1_content = banner_1.querySelector(".sjs_banner_1_content");
    ...
    let banner_2 = document.querySelector(".ap_grid_container.banner_2.womens_basketball");
    ...
    let banner_5 = document.querySelector(".ap_grid_container.banner_5.volleyball");
    ...
    let sjs_banner_5_content = banner_5.querySelector(".sjs_banner_5_content");
    console.log("sjs_banner_5_content:", sjs_banner_5_content);
    ...
    // NAV TIMELINE - BANNER 6
    let banner_6 = document.querySelector(".ap_grid_container.banner_6.mens_baseball");

    let sjs_logo_image_banner_6 = banner_6.querySelector(".sjs_logo_image");
    let sjs_logo_image_container_banner_6 = banner_6.querySelector(".sjs_logo_image_container");
    let sjs_logo_text_banner_6 = banner_6.querySelector(".sjs_logo_text");
    let sjs_logo_text_container_banner_6 = banner_6.querySelector(".sjs_logo_text_container");

    let sjs_banner_6_nav_content_right = banner_6.querySelector(".sjs_nav_content_right")
    let sjs_banner_6_nav_line = banner_6.querySelector(".sjs_banner_6_nav_line")

    // console.log("banner_6:", banner_6);
    // console.log("sjs_logo_image_banner_6:", sjs_logo_image_banner_6);
    // console.log("sjs_logo_text_banner_6:", sjs_logo_text_banner_6);
    // console.log("sjs_banner_6_nav_content_right:", sjs_banner_6_nav_content_right);
    // console.log("sjs_banner_1_nav_content_right:", sjs_banner_1_nav_content_right);
    let sjs_banner_6_sjs_nav_text_link_container = banner_6.querySelectorAll(".sjs_nav_content_right .sjs_nav_text_link_container")
    // console.log("sjs_banner_6_sjs_nav_text_link_container:", sjs_banner_6_sjs_nav_text_link_container);
    let sjs_banner_6_sjs_nav_text_link_text = banner_6.querySelectorAll(".sjs_nav_text_link_text")
    // console.log("sjs_banner_6_sjs_nav_text_link_text:", sjs_banner_6_sjs_nav_text_link_text);
    
    
    let sjs_banner_6_sjs_nav_button = sjs_banner_6_nav_content_right.querySelector(".sjs_button")
    let sjs_banner_6_sjs_nav_button_container = sjs_banner_6_nav_content_right.querySelector(".sjs_button_container")
    // console.log("sjs_banner_6_sjs_nav_button:", sjs_banner_6_sjs_nav_button);

    // Marquee
    let sjs_marquee_banner_6 = banner_6.querySelector(".sjs_marquee")


    // let sjs_banner_6_image = banner_6.querySelector(".sjs_banner_6_image")
    let sjs_banner_6_image_image = banner_6.querySelector(".sjs_banner_6_image_image")
    let sjs_banner_6_image_container = banner_6.querySelector(".sjs_banner_6_image_container")
    let sjs_banner_6_image_containers_images = banner_6.querySelector(".sjs_banner_6_image_containers_small")

    // banner_6 content - including splitText word animation - variables
    let sjs_banner_6_header = banner_6.querySelector(".sjs_banner_header")
    let sjs_banner_6_header_splitLines = new SplitText(sjs_banner_6_header, {type: "lines", linesClass:"line"})
    let sjs_banner_6_subheader = banner_6.querySelector(".sjs_banner_subheader")
    let sjs_banner_6_subheader_splitLines = new SplitText(sjs_banner_6_subheader, {type: "lines", linesClass:"line"})

    // Apply the wrapping to both header and subheader split lines
    wrapLinesInContainers(sjs_banner_6_header_splitLines);
    wrapLinesInContainers(sjs_banner_6_subheader_splitLines);

    let sjs_banner_6_content = banner_6.querySelector(".sjs_banner_6_content");
    let sjs_banner_6_content_button = sjs_banner_6_content.querySelector(".sjs_button")
    console.log("sjs_banner_6_content_button:", sjs_banner_6_content_button);

    // let sjs_banner_6_color_block = banner_6.querySelector(".sjs_banner_6_color_block")

    let tl_banner_6 = gsap.timeline({id: "tl_banner_6", paused: true})
    .from(sjs_logo_image_container_banner_6, {
      yPercent: -110, // Starts 100% to the right
      ease: "power2.out",
      duration: 0.8,
      delay:0.6
    }, 'tl_banner_6')
    .from(sjs_logo_image_banner_6, {
      yPercent: 110, // Starts 100% to the right
      ease: "power2.out",
      duration: 0.8,
      delay:0.6
    }, 'tl_banner_6')
    .from(sjs_logo_text_container_banner_6, {
      yPercent: -110, // Starts 100% to the right
      ease: "power2.out",
      duration: 0.8,
      delay:0.6
    }, 'tl_banner_6')
    .from(sjs_logo_text_banner_6, {
      yPercent: 110, // Starts 100% to the right
      ease: "power2.out",
      duration: 0.8,
      delay:0.6
    ...
    // Marquee 
    .from (sjs_marquee_banner_6, {
      duration:1, 
      opacity:0,
      ease: 'Power4.easeInOut',
    }, '<0.2')

    .from(sjs_banner_6_sjs_nav_text_link_container, {
      yPercent: -110, // Starts 100% to the right
      stagger: 0.3,
      ease: "power2.out",
      duration: 0.8
    }, 'tl_banner_6+=0.6') // "<" aligns start time with previous tween
    .from(sjs_banner_6_sjs_nav_text_link_text, {
      yPercent: 110, // Starts 100% to the left
      stagger: 0.3, // Shorthand syntax works too
      ease: "power2.out",
      duration: 0.8
    ...
    .from(sjs_banner_6_sjs_nav_button_container, {
      yPercent: 110, // Starts 100% to the right
      ease: "power2.out",
      duration: 1
    }, '<0.6') // "<" aligns start time with previous tween

    .from(sjs_banner_6_sjs_nav_button, {
      yPercent: -110, // Starts 100% to the left
      ease: "power2.out",
      duration: 1
    }, '<0.6')
    ...
    // image animation
    // image overlay animation
    .from(sjs_banner_6_image_container, {
      yPercent: -112,
      ease: 'power1.out',
      duration: 1.7,
    }, 'tl_banner_6+=0.6')
    .from(sjs_banner_6_image_image, {
      yPercent: 112,
      scale:1.1,
      ease: 'power1.out',
      duration: 1.7,
    ...
    // side images
    // .from (sjs_banner_6_image_containers_images.children, {
    //   opacity: 0, 
    //   duration:0.5, 
    //   stagger: 0.3, 
    //   ease: "power2.out"
    ...
    // banner content animation
    .from(sjs_banner_6_header_splitLines.lines, {
      // yPercent:110, 
      duration:1, 
      opacity:0,
      stagger: 0.1,
    ...
    .from(sjs_banner_6_subheader_splitLines.lines, {
      // yPercent:110, 
      duration:1, 
      opacity:0,
      stagger: 0.1,
    ...
    .from(sjs_banner_6_content_button, {
      // yPercent:110, 
      duration:1, 
      opacity:0,
      ease: 'Power4.easeInOut',
