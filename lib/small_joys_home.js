...
ScrollTrigger.config({
  // Prevents constant recalculation on mobile
  // ignoreMobileResize: true,
  // Reduces refresh triggers
...
function small_joys_home() {
  ...
  /* 062825 adding from claude to help w sj home mobile animations */
  // Add this to your CSS for better mobile performance
  const mobileStyles = `
    .sj_banner_1_image,
    .sjs_train_1_blade_image {
  ...
  function initLogoToNavAnimation() {
    ...
    scrollTriggers.logoToNav = ScrollTrigger.create({
      ...
      fastScrollEnd: true,
      preventOverlaps: true // Prevents conflicting with other animations
    });
