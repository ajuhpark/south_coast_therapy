...
for (let i = 0; i < 20; i++) {
  ...
  Composite.add(engine.world, circle)
    ...
    Example.timescale = function() {
        ...
        // Create a grid of small bouncy circles - centered
        // Reference to "Swordfish" - a movie with bullet-time effects
        World.add(world, Composites.stack(matter_container_2.clientWidth / 2 - 100, 100, 3, 2, 20, 40, function(x, y) {
            // Each circle has random radius between 10-20 pixels
            // return Bodies.circle(x, y, Common.random(10, 20), bodyOptions);
            return Bodies.circle(x, y, Common.random(50, 200), bodyOptions);
        }));

        // Create larger random objects - centered
        World.add(world, Composites.stack(matter_container_2.clientWidth / 2 - 100, 50, 3, 2, 0, 0, function(x, y) {
            ...
            case 0:
                ...
                if (Common.random() < 0.8) {
                    ...
                    return Bodies.rectangle(x, y, Common.random(50, 200), Common.random(50, 200), bodyOptions);
                } else {
                    // return Bodies.rectangle(x, y, Common.random(80, 120), Common.random(20, 30), bodyOptions);
                    return Bodies.rectangle(x, y, Common.random(80, 200), Common.random(50, 100), bodyOptions);
                }
            case 1:
                ...
                return Bodies.polygon(x, y, Math.round(Common.random(80, 200)), Common.random(50, 100), bodyOptions);
            }
        }));
